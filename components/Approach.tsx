...
const Card: React.FC<CardProps> = ({ title, icon, children, des }) => {
  ...
  return (
    <div
      ...
      className="border border-black/[0.2] dark:border-white/[0.2] max-w-sm w-full mx-auto p-4 relative lg:h-[35rem] rounded-3xl group/canvas-card flex items-center justify-center"
      style={{
